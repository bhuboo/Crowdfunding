...
export default function Contactuscode() {
    return (
        <>
                                ...
                                <div className="row">
                                    <div className="col-lg-6 mb-4 pb-2">
                                        <div className="form-group">
                                            <label for="loan_amount" className="form-label">Amount</label>
                                            <input type="number" className="form-control shadow-none" id="loan_amount" placeholder="ex: 25000" />
                                        </div>
                                    </div>
                                    <div className="col-lg-6 mb-4 pb-2">
                                        <div className="form-group">
                                            <label for="loan_how_long_for" className="form-label">How long for?</label>
                                    ...
                                    <div className="col-lg-12 mb-4 pb-2">
                                        <div className="form-group">
                                            <label for="loan_repayment" className="form-label">Repayment</label>
                                            <input type="number" className="form-control shadow-none" id="loan_repayment" disabled />
                                        </div>
                                    </div>
                                    <div className="col-lg-6 mb-4 pb-2">
                                        <div className="form-group">
                                            <label for="loan_full_name" className="form-label">Full Name</label>
                                            <input type="text" className="form-control shadow-none" id="loan_full_name" />
                                        </div>
                                    </div>
                                    <div className="col-lg-6 mb-4 pb-2">
                                        <div className="form-group">
                                            <label for="loan_email_address" className="form-label">Email address</label>
                    ...
                    <div className="row">
                        <div className="col-8 mx-auto text-center">
                            ...
                            <ul className="list-inline breadcrumbs text-capitalize" style={{ fontWeight: 500 }}>
                                ...
                                <li className="list-inline-item">/ &nbsp; <Link to={"/contactus"} href="contact.html">Contact</Link>
                                </li>
                            </ul>
                        </div>
                    </div>
                                    ...
                                    <div className="col-lg-6 mt-5 mt-lg-0">
                                        <div className="contact-info">
                                            ...
                                            <div className="block mt-4">
                                                ...
                                                <div className="content">231 Ross Street.
                                                    <br />K7A 1C2.
                                                    <br />Smiths Falls</div>
                                            </div>
                                            <div className="block mt-4">
                                                <h4 className="h5">UK Office</h4>
                                                <div className="content">57 Folkestone Road.
                                                    <br />AB54 5XQ,
                                                    <br />Winston</div>
                                            </div>
                                            <div className="block">
