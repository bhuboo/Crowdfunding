...
import img from '../../../assets/Backgroundlandscape(2).jpeg'
import Scarlet from '../../../Template/images/about/team-1.jpg'
import Claire from '../../../Template/images/about/team-2.jpg'
import Leslie from '../../../Template/images/about/team-3.jpg'
export default function Aboutuscode() {
    return (
        <>
            <div className="modal applyLoanModal fade" id="applyLoan" tabIndex="-1" aria-labelledby="applyLoanLabel" aria-hidden="true">
                <div className="modal-dialog modal-dialog-centered">
                    <div className="modal-content">
                        <div className="modal-header border-bottom-0">
                            <h4 className="modal-title" id="exampleModalLabel">How much do you need?</h4>
                                ...
                                <div className="row">
                                    <div className="col-lg-6 mb-4 pb-2">
                                        <div className="form-group">
                                            <label htmlFor="loan_amount" className="form-label">Amount</label>
                                            <input type="number" className="form-control shadow-none" id="loan_amount" placeholder="ex: 25000" />
                                        </div>
                                    </div>
                                    <div className="col-lg-6 mb-4 pb-2">
                                        <div className="form-group">
                                            <label htmlFor="loan_how_long_for" className="form-label">How long for?</label>
                                            <input type="number" className="form-control shadow-none" id="loan_how_long_for" placeholder="ex: 12" />
                                        </div>
                                    </div>
                                    <div className="col-lg-12 mb-4 pb-2">
                                        <div className="form-group">
                                            <label htmlFor="loan_repayment" className="form-label">Repayment</label>
                                            <input type="number" className="form-control shadow-none" id="loan_repayment" disabled />
                                        </div>
                                    </div>
                                    <div className="col-lg-6 mb-4 pb-2">
                                        <div className="form-group">
                                            <label htmlFor="loan_full_name" className="form-label">Full Name</label>
                                            <input type="text" className="form-control shadow-none" id="loan_full_name" />
                                        </div>
                                    </div>
                                    <div className="col-lg-6 mb-4 pb-2">
                                        <div className="form-group">
                                            <label htmlFor="loan_email_address" className="form-label">Email address</label>
                                            <input type="email" className="form-control shadow-none" id="loan_email_address" />
                                        </div>
                                    </div>
                                    <div className="col-lg-12">
                                        <button type="submit" className="btn btn-primary w-100">Get Your Loan Now</button>
                                    </div>
                                </div>
                            </form>
                        </div>
                    ...
                    <div className="row">
                        <div className="col-8 mx-auto text-center">
                            ...
                            <ul className="list-inline breadcrumbs text-capitalize" style={{ fontWeight: 500 }}>
                                <li className="list-inline-item"><Link to={"/"} href="index.html">Home</Link>
                                </li>
                                <li className="list-inline-item">/ &nbsp; <Link to={"/aboutus"} >About</Link>
                                </li>
                            </ul>
                        </div>
                    </div>
                    ...
                    <div className="row justify-content-center align-items-center">
                        <div className="col-lg-7">
                            <div className="section-title">
                                <p className="text-primary text-uppercase fw-bold mb-3">About Plat-form</p>
                                <h2 className="h1 mb-4">Share your innovative<br />  ideas easily</h2>
                        ...
                        <div className="col-lg-4 mt-5 mt-lg-0">
                            <img loading="lazy" decoding="async" src={img} alt="Business Loans &lt;br&gt; For Daily Expenses" className="rounded w-100" />
                        </div>
                    </div>
                </div>
            </section>
                ...
                <div className="container">
                    <div className="row justify-content-center">
                        <div className="col-lg-4 col-md-6 mb-5 mb-lg-0 text-center icon-box-item">
                            ...
                            <p className="px-lg-5">Revolutionizing the digital landscape with cutting-edge innovations.</p>
                        </div>
                        <div className="col-lg-4 col-md-6 mb-5 mb-lg-0 text-center icon-box-item">
                            <div className="icon icon-lg bg-transparent mb-4"><i className="fas fa-file-alt text-primary"></i>
                            </div>
                            <h3>Share Your Ideas Easily</h3>
                            <p className="px-lg-5">receive valuable feedback from a community.</p>
                        </div>
                        <div className="col-lg-4 col-md-6 mb-5 mb-lg-0 text-center icon-box-item">
                            <div className="icon icon-lg bg-transparent mb-4"><i className="fas fa-briefcase text-primary"></i>
                            </div>
                            <h3>End-to-End secure</h3>
                            <p className="px-lg-5">Ensuring end-to-end security with innovative solutions.</p>
                        </div>
                    </div>
                </div>
            </section>
                ...
                <div className="container">
                    ...
                    <div className="row position-relative">
                        <div className="col-xl-3 col-lg-4 col-md-6 mt-4">
                            <div className="card bg-transparent border-0 text-center">
                                <div className="card-img">
                                    <img loading="lazy" decoding="async" src={Scarlet} alt="Scarlet Pena" className="rounded w-100" width="300" height="332" />
                                    <ul className="card-social list-inline">
                                        <li className="list-inline-item"><a className="facebook" href="#"><i className="fab fa-facebook"></i></a>
                                        </li>
                                        <li className="list-inline-item"><a className="twitter" href="#"><i className="fab fa-twitter"></i></a>
                                        </li>
                                        <li className="list-inline-item"><a className="instagram" href="#"><i className="fab fa-instagram"></i></a>
                                        </li>
                                    </ul>
                                </div>
                        ...
                        <div className="col-xl-3 col-lg-4 col-md-6 mt-4">
                            <div className="card bg-transparent border-0 text-center">
                                <div className="card-img">
                                    <img loading="lazy" decoding="async" src={Claire} alt="Claire Simmmons" className="rounded w-100" width="300" height="333" />
                                    <ul className="card-social list-inline">
                                        <li className="list-inline-item"><a className="facebook" href="#"><i className="fab fa-facebook"></i></a>
                                        </li>
                                        <li className="list-inline-item"><a className="twitter" href="#"><i className="fab fa-twitter"></i></a>
                        ...
                        <div className="col-xl-3 col-lg-4 col-md-6 mt-4">
                            <div className="card bg-transparent border-0 text-center">
                                <div className="card-img">
                                    <img loading="lazy" decoding="async" src={Leslie} alt="Leslie Pena" className="rounded w-100" width="300" height="333" />
                                    <ul className="card-social list-inline">
                                        <li className="list-inline-item"><a className="facebook" href="#"><i className="fab fa-facebook"></i></a>
                                        </li>
                                        <li className="list-inline-item"><a className="twitter" href="#"><i className="fab fa-twitter"></i></a>
