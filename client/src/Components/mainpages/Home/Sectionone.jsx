...
import img1 from '../../../assets/landscapebackground(1).png'
                    ...
                    <div className="col-lg-6 mb-5 mb-lg-0">
                        <div className="block text-center text-lg-start pe-0 pe-xl-5">
                            <h1 className="text-capitalize mb-4">
                                {
                                    user.UserType == 1 ?
                                        "Do you have innovative ideas that can take your business to the next level?"
                                        :
                                        ""
                                }
                            ...
                            <p className="mb-4">
                                {
                                    user.UserType == 1 ?
                                        "Look no further than [Platform Name]. Our platform empowers entrepreneurs like you to share your ideas and receive valuable feedback from a community of like-minded individuals. With the help of our platform, you can take your success to new heights. Sign up now and start your journey towards achieving your goals."
                                        :
                                        ""
                                }
                            </p>
                            {
                                user.UserType == 1 ?
                                    <Link to={"/shareideas"} type="button" className="btn btn-primary" href="#" data-bs-toggle="modal" data-bs-target="#applyLoan">
                                        Share Your Ideas
